...
//FUNCION PARA ENCENDER NUESTRO LCD
void EncenderLCD(){
                    while (Serial.available()) {    // Leer el valor enviado por el Puerto serial
                    delay(retardo);
                    char c  = Serial.read();     // Lee los caracteres
...
//FUNCION PARA ACTIVAR EL SERVOMOTOR HACIA LA DERECHA
void paso_der(){ 
             digitalWrite(11, LOW); 
             digitalWrite(10, LOW);  
             digitalWrite(9, HIGH);  
...
//FUNCION PARA ACTIVAR EL SERVOMOTOR HACIA LA IZQUEIRDA
void paso_izq() {        
             digitalWrite(11, HIGH); 
             digitalWrite(10, HIGH);  
             digitalWrite(9, LOW);  
...
//FUNCION PARA APAGAR EL SERVOMOTOR        
void apagado() {         
             digitalWrite(11, LOW); 
             digitalWrite(10, LOW);  
             digitalWrite(9, LOW);  
